  ...
  return (
    <section>
      ...
      <div className="mt-5 grid xs:grid-cols-1 lg:grid-cols-2 xs:m-5 md:m-12 gap-5 pb-8">
        ...
        <SingleCard name="Jake Zeng" position="Director of Outreach" image="/images/jake.png" description="A sophomore at American Heritage School in Plantation, Florida, Jake is a student primarily interested in studying law, economics, the courts, and politics. Outside of SPRING, Jake is on the US Development Team for debate and competes in mock trial and moot court. Jake loves playing chess, reading travel magazines, and keeping up with friends." />
